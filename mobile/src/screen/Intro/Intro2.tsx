...
type Props = NativeStackScreenProps<RootStackParamList, "Intro2">;

export default function Intro2({ navigation }: Props) {
  const onSkip = () => {
      ...
      >
        ...
        <View style={styles.bottomArea}>
          ...
          <View style={styles.content}>
            <Text style={styles.subtitle}>Your fitness, your rules</Text>
